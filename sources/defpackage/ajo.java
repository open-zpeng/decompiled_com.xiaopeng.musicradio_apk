...
/* compiled from: ActivityPlaylistBlueBinding.java */
...
public abstract class ajo extends ViewDataBinding {
    ...
    public ajo(f fVar, View view, int i, XImageView xImageView, ClickableLoadingTipsView clickableLoadingTipsView, MusicListLogoView musicListLogoView, XRelativeLayout xRelativeLayout, ListRecyclerView listRecyclerView, MineTitleBarLayout mineTitleBarLayout, XButton xButton) {
        super(fVar, view, i);
        this.c = xImageView;
