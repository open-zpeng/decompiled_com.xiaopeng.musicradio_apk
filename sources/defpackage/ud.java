...
public class ud {
    ...
    public static String a() {
        if (TextUtils.isEmpty(l)) {
            e("adashbc.ut.taobao.com");
            if (!TextUtils.isEmpty(m)) {
                e(m);
            }
            Context c2 = uc.c();
            e(a(c2, "utanalytics_https_host"));
            e(vd.a(c2, "utanalytics_https_host"));
        }
        return l;
    }
    ...
    public static void a(Map<String, String> map) {
        uw.a("Config", "[turnOnRealTimeDebug] params:", map);
        if (map != null) {
    ...
    public static String f() {
        if ("l0".equalsIgnoreCase(p)) {
            ...
            uw.a("Config", p, "net config");
            String g2 = g("b01na");
            if (g2 != null) {
                try {
                    JSONObject jSONObject = new JSONObject(g2).getJSONObject("content");
                    if (jSONObject != null) {
    ...
    private static String g(String str) {
        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(uc.c());
