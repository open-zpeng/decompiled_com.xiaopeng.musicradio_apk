...
/* compiled from: ActivityPlaylistBlueBindingImpl.java */
...
public class ajp extends ajo {
    ...
    static {
        k.put(aht.c.loading_tips_view, 1);
        k.put(aht.c.title_bar, 2);
        k.put(aht.c.logo_view, 3);
    ...
    public ajp(f fVar, View view) {
        this(fVar, view, a(fVar, view, 8, j, k));
    }

    private ajp(f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (XImageView) objArr[7], (ClickableLoadingTipsView) objArr[1], (MusicListLogoView) objArr[3], (XRelativeLayout) objArr[5], (ListRecyclerView) objArr[4], (MineTitleBarLayout) objArr[2], (XButton) objArr[6]);
        this.m = -1L;
