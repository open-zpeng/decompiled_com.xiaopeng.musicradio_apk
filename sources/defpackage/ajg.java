...
/* compiled from: ActivityCollectedMusicListBinding.java */
...
public abstract class ajg extends ViewDataBinding {
    ...
    public final XButton j;

    /* JADX INFO: Access modifiers changed from: protected */
    public ajg(f fVar, View view, int i, XImageView xImageView, ClickableLoadingTipsView clickableLoadingTipsView, MusicListLogoView musicListLogoView, XRelativeLayout xRelativeLayout, ListRecyclerView listRecyclerView, MineTitleBarLayout mineTitleBarLayout, XButton xButton, XButton xButton2) {
        super(fVar, view, i);
        this.c = xImageView;
