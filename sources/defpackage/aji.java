...
/* compiled from: ActivityCustomDetailListBinding.java */
...
public abstract class aji extends ViewDataBinding {
    ...
    public aji(f fVar, View view, int i, XImageView xImageView, ClickableLoadingTipsView clickableLoadingTipsView, MusicListLogoView musicListLogoView, XRelativeLayout xRelativeLayout, ListRecyclerView listRecyclerView, MineTitleBarLayout mineTitleBarLayout, XButton xButton) {
        super(fVar, view, i);
        this.c = xImageView;
