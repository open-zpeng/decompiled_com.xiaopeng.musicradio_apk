...
class e {
    ...
    public static final void a(byte[] bArr, String str, XmlSerializer xmlSerializer) {
        if (bArr == null) {
            xmlSerializer.startTag(null, "null");
            xmlSerializer.endTag(null, "null");
            return;
    ...
    public static final void a(int[] iArr, String str, XmlSerializer xmlSerializer) {
        if (iArr == null) {
            xmlSerializer.startTag(null, "null");
            xmlSerializer.endTag(null, "null");
            return;
    ...
    public static final HashMap m69a(XmlPullParser xmlPullParser, String str, String[] strArr) {
    ...
    public static final ArrayList a(XmlPullParser xmlPullParser, String str, String[] strArr) {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m70a(XmlPullParser xmlPullParser, String str, String[] strArr) {
        try {
    ...
    private static final Object b(XmlPullParser xmlPullParser, String[] strArr) {
        ...
        if (!name.equals("null")) {
            if (name.equals("string")) {
                ...
                xmlPullParser.next();
                int[] m70a = m70a(xmlPullParser, "int-array", strArr);
                strArr[0] = attributeValue;
                return m70a;
            } else if (name.equals("map")) {
                xmlPullParser.next();
                HashMap m69a = m69a(xmlPullParser, "map", strArr);
                strArr[0] = attributeValue;
                return m69a;
