...
public class MainHotSingerResultBean extends BaseBean {
    private List<DataBean.ArtistGroupsBean.ListBean> data;

    public List<DataBean.ArtistGroupsBean.ListBean> getData() {
        return this.data;
    }

    public void setData(List<DataBean.ArtistGroupsBean.ListBean> list) {
        this.data = list;
    }
