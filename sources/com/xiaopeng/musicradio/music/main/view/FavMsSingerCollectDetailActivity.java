...
import com.xiaopeng.musicradio.music.singer.singer.view.MsSingerCollectDetailActivity;
import com.xiaopeng.xui.widget.XTextView;
@Route(path = "/music/activity/fav_singer_collect_detail")
/* loaded from: classes.dex */
public class FavMsSingerCollectDetailActivity extends MsSingerCollectDetailActivity {
    private XTextView u;
    ...
    @Override // com.xiaopeng.musicradio.music.singer.singer.view.MsSingerCollectDetailActivity, com.xiaopeng.musicradio.music.main.view.MsMusicDetailActivity
    public void a() {
        super.a();
        if (getIntent() != null) {
