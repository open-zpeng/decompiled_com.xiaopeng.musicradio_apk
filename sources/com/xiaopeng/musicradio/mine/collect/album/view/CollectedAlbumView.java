...
public class CollectedAlbumView extends DataListFrameLayout<c, CollectedAlbumPresenter> implements bic, c {
    ...
    public CollectedAlbumView(Context context) {
        this(context, null);
    }

    public CollectedAlbumView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public CollectedAlbumView(Context context, AttributeSet attributeSet, int i) {
    ...
    /* renamed from: e */
    public CollectedAlbumPresenter a() {
        return new CollectedAlbumPresenter(4, "FROM_MAIN");
    }
    ...
    @Override // com.xiaopeng.musicradio.commonui.base.BaseFrameLayout
    protected void c() {
        this.c.a(aht.e.title_collected_album, 0, 1);
        this.d = new ahw(getContext());
        this.c.c.setAdapter(this.d);
        this.c.c.addItemDecoration(new ait(getResources().getDimensionPixelSize(aht.a.mine_album_view_item_margin_left)));
        ae.a(this, 8);
        amk.a(this.c.f, getContext().getString(aht.e.title_collected_album), "title_collected_album");
        amk.a((BaseRecycleView) this.c.c, "MainMineCollect", false, true, "alb_list");
    ...
    @Override // com.xiaopeng.musicradio.commonui.base.BaseFrameLayout
    protected void d() {
        this.d.a((c.b) new c.b<ViewDataBinding, MusicRadioItem>() { // from class: com.xiaopeng.musicradio.mine.collect.album.view.CollectedAlbumView.1
            ...
            public void a(View view, ViewDataBinding viewDataBinding, MusicRadioItem musicRadioItem, int i) {
                LogUtils.i("CollectedAlbumView", "onItemClicked:" + i);
                aml.a(view, musicRadioItem, "collect");
            }
        });
        this.c.a(new View.OnClickListener() { // from class: com.xiaopeng.musicradio.mine.collect.album.view.CollectedAlbumView.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                aja.c();
                sp.a().a("/mine/activity/collect/album").navigation();
            }
        });
    }
    ...
    public void a(List list, int i) {
        LogUtils.i("CollectedAlbumView", "onDataListLoaded:" + this.d.a());
        if (this.d.a() <= 0) {
            ae.a(this, 8);
        } else {
            ae.a(this, 0);
