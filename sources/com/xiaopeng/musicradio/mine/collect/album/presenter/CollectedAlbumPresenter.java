package com.xiaopeng.musicradio.mine.collect.album.presenter;
...
import com.xiaopeng.musicradio.mine.collect.album.view.c;
...
public class CollectedAlbumPresenter extends MsDataBasePresenter<c> {
    public CollectedAlbumPresenter(int i, String str) {
        super(i, str);
    }
    ...
    public void a(e eVar) {
        final LiveData<f<MusicRadioItem>> b = aml.b(eVar);
        b.a(new o<f<MusicRadioItem>>() { // from class: com.xiaopeng.musicradio.mine.collect.album.presenter.CollectedAlbumPresenter.1
            @Override // androidx.lifecycle.o
            public void a(f<MusicRadioItem> fVar) {
                b.b((o) this);
                CollectedAlbumPresenter.this.a((f) fVar);
                c a = CollectedAlbumPresenter.this.a();
                if (CollectedAlbumPresenter.this.i() || fVar == null || !(a instanceof View)) {
                    return;
                }
                ahz.a().a((View) CollectedAlbumPresenter.this.a(), CollectedAlbumPresenter.this.b(fVar.o));
            }
        });
    }
    ...
    protected void a(String str) {
        ...
        LogUtils.i("CollectedAlbumPresenter", "updatePlayingStatus:playing=" + a + ",from=" + str);
        if (a) {
            final ListSignBean listSignBean = (ListSignBean) z.a(aml.e(), (Class<Object>) ListSignBean.class);
            if (listSignBean != null) {
                a().a(true, (c.a) new c.a<MusicRadioItem>(null) { // from class: com.xiaopeng.musicradio.mine.collect.album.presenter.CollectedAlbumPresenter.2
