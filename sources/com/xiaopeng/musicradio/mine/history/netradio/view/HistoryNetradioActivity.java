...
@Route(path = "/mine/activity/history/netradio")
/* loaded from: classes.dex */
public class HistoryNetradioActivity extends com.xiaopeng.musicradio.mine.common.view.a<ajm, c, HistoryNetradioPresenter> implements c {
    @Override // com.xiaopeng.musicradio.commonui.vui.a
    public String m() {
        return "MineHistoryNetRadio";
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.xiaopeng.musicradio.commonui.base.a
    /* renamed from: q */
    public HistoryNetradioPresenter e() {
    ...
    protected com.xiaopeng.musicradio.datalist.c r() {
        return new akz(this, 20, this, true) { // from class: com.xiaopeng.musicradio.mine.history.netradio.view.HistoryNetradioActivity.1
    ...
    public void T_() {
        super.T_();
        setTitle(aht.e.title_history_netradio);
    ...
    public void i() {
        super.i();
        this.j.a((c.b) new c.b<ViewDataBinding, NetRadioInfo>() { // from class: com.xiaopeng.musicradio.mine.history.netradio.view.HistoryNetradioActivity.2
            ...
            public void a(View view, ViewDataBinding viewDataBinding, NetRadioInfo netRadioInfo, int i) {
                LogUtils.i("HistoryNetradioActivity", "onItemClicked:" + i + ListSignBean.COLLECTID_SUFFIX + HistoryNetradioActivity.this.j.p());
                if (view.getId() == aht.c.btn_delete || HistoryNetradioActivity.this.j.p() != 0) {
                    HistoryNetradioActivity.this.a(netRadioInfo);
                } else {
                    amm.a(netRadioInfo);
                }
            }
