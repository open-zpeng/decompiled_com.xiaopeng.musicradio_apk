...
public class ScrollByYEvent extends BaseEvent {
    ...
    public <T extends View> T run(T t, bin binVar) {
        if (t != null && binVar != null && binVar.getResultActions() != null && !binVar.getResultActions().isEmpty() && big.SCROLLBYY.a().equals(binVar.getResultActions().get(0))) {
            String str = (String) VuiUtils.getValueByName(binVar, VuiConstants.EVENT_VALUE_DIRECTION);
            Double d = (Double) VuiUtils.getValueByName(binVar, VuiConstants.EVENT_VALUE_OFFSET);
            if (str == null || d == null) {
                return t;
            }
            ...
            if (t instanceof RecyclerView) {
                ...
                if (height == 0) {
                    ...
                    smoothMoveToPosition(recyclerView, recyclerView.getAdapter().a() - 1);
                } else {
    ...
    public void smoothMoveToPosition(RecyclerView recyclerView, int i) {
        if (recyclerView.getLayoutManager() != null) {
            ...
            recyclerView.getLayoutManager().a(this.mScroller);
        }
    }
}
