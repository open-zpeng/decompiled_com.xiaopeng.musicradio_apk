...
public interface ISecurityModule {
    ...
    String generateIndividualDataForServer();

    Security.EncryptionType getEncryptionType();

    String getIndividualFlag();

    String getIndividualRequestStr();

    String getString(String str);

    boolean individualWithData(String str);

    ISecurityModule init(Context context);

    ISecurityModule initForIndividual(Context context);
