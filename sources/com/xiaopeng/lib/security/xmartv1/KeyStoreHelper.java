...
public final class KeyStoreHelper {
    ...
    public static boolean init() {
        ...
        if (!loadWithXmartKeyStore) {
            abr.a().a(6001, "failed to init xmart keystore");
            loadWithXmartKeyStore = loadWithDefaultKeyStore();
            if (!loadWithXmartKeyStore) {
                abr.a().a(6002, "failed to init default keystore");
            }
        }
    ...
    public static boolean hasValidIndividualKeys() {
        ...
        if (!z) {
            abr.a().a(PlaybackException.ERROR_CODE_DRM_UNSPECIFIED, "no valid individual keys");
        }
        return z;
    }

    public static boolean cleanIndividualKeys() {
        if (sKeyStore == null) {
            LogUtils.d(TAG, "KeyStore was not initialized!");
            return false;
        }
    ...
    public static void writeSecretData(Map<String, byte[]> map) {
        if (sKeyStore == null) {
            init();
        }
