...
public class IrdetoSecurity implements ISecurityModule {
    ...
    @Override // com.xiaopeng.lib.security.ISecurityModule
    public IrdetoSecurity init(Context context) {
        initInternal(context, false);
        return this;
    }

    @Override // com.xiaopeng.lib.security.ISecurityModule
    public IrdetoSecurity initForIndividual(Context context) {
    ...
    @Override // com.xiaopeng.lib.security.ISecurityModule
    public String getIndividualRequestStr() {
        return isf.isfGetProvisionRequest();
    }

    @Override // com.xiaopeng.lib.security.ISecurityModule
    public String generateIndividualDataForServer() {
        return isf.isfGenerateOpaqueData();
    }

    @Override // com.xiaopeng.lib.security.ISecurityModule
    public boolean individualWithData(String str) {
    ...
    public static void saveToken(String[] strArr, String[] strArr2) {
        synchronized (IrdetoSecurity.class) {
            if (sIsInitSuccess) {
                try {
