...
public class XLogger implements Handler.Callback, LogUtils.Logger {
    ...
    public XLogger(XLoggerFactory.XLoggerBuilder xLoggerBuilder) {
    ...
    public void logByLevel(int i, String str, String str2, String str3) {
        ...
        switch (i) {
            case 2:
                this.mXlog.a(str2, str3, null, 0, this.mPid, id, this.mMainThreadId, str);
                return;
            case 3:
                this.mXlog.b(str2, str3, null, 0, this.mPid, id, this.mMainThreadId, str);
                return;
            case 4:
                this.mXlog.c(str2, str3, null, 0, this.mPid, id, this.mMainThreadId, str);
                return;
            case 5:
                this.mXlog.d(str2, str3, null, 0, this.mPid, id, this.mMainThreadId, str);
                return;
            case 6:
                this.mXlog.e(str2, str3, null, 0, this.mPid, id, this.mMainThreadId, str);
                return;
            default:
                return;
        }
