...
public class ZipUtils {
    ...
    */
    ...
    public static void zipFileOrDirectory(ZipOutputStream zipOutputStream, File file, String str) {
        zipFileOrDirectory(zipOutputStream, file, str, true);
    }

    public static void zipFileOrDirectory(ZipOutputStream zipOutputStream, File file, String str, boolean z) {
    ...
    public static File zipMultiFiles(String str, List<String> list) {
        return zipMultiFiles(str, list, true);
    }

    public static File zipMultiFiles(String str, List<String> list, boolean z) {
        try {
    ...
    public static File zipMultiFilesWithThrow(String str, List<String> list) {
        return zipMultiFilesWithThrow(str, list, true);
    }

    public static File zipMultiFilesWithThrow(String str, List<String> list, boolean z) {
