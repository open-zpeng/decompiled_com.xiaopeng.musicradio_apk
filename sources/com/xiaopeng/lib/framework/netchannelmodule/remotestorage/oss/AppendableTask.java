...
public class AppendableTask extends BaseOssTask {
    ...
    public AppendableTask append(byte[] bArr) {
    ...
    public void appendToOssObject(OSS oss) {
        ...
        try {
            ...
            LogUtils.e(TAG, "append error!", valueOf);
            ...
            if (!StorageCounter.isInternationVersion()) {
                IDataLog iDataLog3 = (IDataLog) Module.get(abh.class).get(IDataLog.class);
