...
public class SimpleUploadTask extends BaseOssTask {
    ...
    public void executeUploadTask(Token token) {
            ...
            try {
                ...
                try {
                    ...
                    if (completeMultipartUpload != null && completeMultipartUpload.getLocation() != null) {
                        LogUtils.d("multipartUploadWithServerCallback with location:", completeMultipartUpload.getLocation());
                    }
                    ...
                    closeFileStream(fileInputStream);
                    if (!StorageCounter.isInternationVersion()) {
                        IDataLog iDataLog2 = (IDataLog) Module.get(abh.class).get(IDataLog.class);
