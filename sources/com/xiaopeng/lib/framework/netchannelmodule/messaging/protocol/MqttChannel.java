...
public class MqttChannel {
    ...
    public synchronized void init(Application application, final AbstractChannelProfile abstractChannelProfile) {
        ...
        bnb.a(LoggerImpl.class.getName());
    ...
    public void reInitMqttWithLastProfile() {
        reInitMqtt(null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void reInitMqtt(AbstractChannelProfile abstractChannelProfile) {
    ...
    private synchronized void closeCurrentConnection() {
        ...
        try {
            ...
            this.mMqttAndroidClient.a((bkh) null);
        } catch (Exception e) {
    ...
    public boolean connectMqtt() {
        if (this.mMqttAndroidClient == null || this.mMqttConnectOptions == null) {
            ...
            try {
                ...
                this.mMqttAndroidClient.a(this.mMqttConnectOptions, this.mApplicationContext, new bkh() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.5
                    @Override // defpackage.bkh
                    public void onSuccess(bkl bklVar) {
                        MqttChannel mqttChannel = MqttChannel.this;
                        mqttChannel.logInternal("onSuccess asyncActionToken=" + bklVar);
                        try {
                    ...
                    public void onFailure(bkl bklVar, Throwable th) {
                        ...
                        try {
                            ...
                            MqttChannel.this.mMqttAndroidClient.a((bkh) null);
                        } catch (bks e) {
                            e.printStackTrace();
                        }
                        if (th != null) {
                        ...
                        mqttChannel2.log("onFailure asyncActionToken=" + bklVar + " exception=" + th);
                    }
                });
                return true;
            } catch (Exception e) {
    ...
    private boolean initAndroidClientSuccess() {
        ...
        bkp bkpVar = this.mMemoryPersistence;
        if (bkpVar instanceof MemoryPersistenceProxy) {
            ((MemoryPersistenceProxy) bkpVar).setTraceEnabled(this.mChannelProfile.enableTrace());
        }
    ...
    public void subscribeInternal(final String str) {
        if (this.mScheduler.allowToSubscribe()) {
            try {
                this.mMqttAndroidClient.a(str, this.mChannelProfile.defaultQoSLevel(), (Object) null, new bkh() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.8
                    @Override // defpackage.bkh
                    public void onSuccess(bkl bklVar) {
                        MqttChannel mqttChannel = MqttChannel.this;
    ...
    public long publishMessage(String str, String str2) {
        return publishMessage(str, str2.getBytes(), this.mChannelProfile.defaultQoSLevel());
    }

    public long publishMessage(String str, byte[] bArr) {
        return publishMessage(str, bArr, this.mChannelProfile.defaultQoSLevel());
    }

    public long publishMessage(String str, byte[] bArr, int i) {
        long j;
        ...
        synchronized (this) {
            ...
            try {
                ...
                j = this.mMqttAndroidClient.a(str, bktVar, (Object) null, new bkh() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.9
                    @Override // defpackage.bkh
                    public void onSuccess(bkl bklVar) {
                    }
                    ...
                    public void onFailure(bkl bklVar, Throwable th) {
                        ...
                        if (th instanceof bks) {
                            bks bksVar = (bks) th;
                            MqttChannel.this.mEventSender.postDeliveryFailure(bklVar.f(), bksVar.a());
                            str2 = "Failed to publish, exception (A):" + bksVar;
                            MqttChannel.this.logInternal(str2);
                        } else {
                            String str3 = "Failed to publish, exception (B):" + th;
                            MqttChannel.this.logInternal(str3);
                            MqttChannel.this.mEventSender.postDeliveryFailure(bklVar.f(), 0);
                            str2 = str3;
                        }
                ...
                if (e instanceof bks) {
                    this.mEventSender.postDeliveryFailure(0L, ((bks) e).a());
                } else {
    ...
    /* loaded from: classes.dex */
    public class MqttCallbackImpl implements bko {
        ...
        public void messageArrived(String str, bkt bktVar) {
            ...
            MqttChannel.this.mEventSender.postReceivedMessage(str, bktVar.a());
            MqttChannel.this.mScheduler.resetFail();
            if (MqttChannel.this.mCounter != null) {
        ...
        public void deliveryComplete(bkj bkjVar) {
            if (BuildInfoUtils.isUserVersion()) {
                MqttChannel.this.mEventSender.postDeliveryCompleted(bkjVar.f());
            } else {
                try {
                    MqttChannel.this.mEventSender.postDeliveryCompleted(bkjVar.f(), bkjVar.a().a());
                } catch (Exception e) {
            ...
            long j = 0;
            try {
                if (bkjVar.a() != null && bkjVar.a().a() != null) {
                    j = bkjVar.a().a().length;
                }
            } catch (Exception unused) {
            }
    ...
    public class ExtremePingSender {
        ...
        private bkh mPingActionListener;
        private int mSucceedCount;

        private ExtremePingSender() {
            this.mActiveInterval = 10000;
            this.mActiveRecoverDelay = 8000;
            this.mPingActionListener = new bkh() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.ExtremePingSender.1
                @Override // defpackage.bkh
                public void onSuccess(bkl bklVar) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public boolean sendExtremePing(bkh bkhVar) {
            boolean z = false;
            if (MqttChannel.this.isConnected()) {
                synchronized (this) {
                    try {
                        MqttChannel.this.mMqttAndroidClient.b(bkhVar);
                        z = true;
                    } catch (Exception e) {
                        bkhVar.onFailure(null, e);
                    }
                }
                return z;
            }
