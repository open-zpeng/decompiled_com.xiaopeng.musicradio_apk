...
public interface ICiuController extends ILifeCycle {
    ...
    void setCiuCarWash(boolean z);

    void setCiuConfigurationActive(int i);

    void setCiuDelayOff(int i);

    void setCiuDeliveryUploadMode(int i);

    void setCiuRainSw(int i);

    void setDeleteFaceId(int i);

    void setDeleteMulti(int i, int i2);

    void setDistractionStatus(int i);

    void setDmsMode(int i);

    void setDmsStatus(int i);

    void setDmsStatus(int i, int i2, int i3, int i4);

    void setDvrEnable(boolean z);

    void setDvrLockMode(int i);

    void setDvrMode(int i);

    void setFaceActionRequest(int i);

    void setFaceIdMode(int i);

    void setFaceIdSw(int i);

    void setFatIgStatus(int i);

    void setFatigueStatus(int i);

    void setFirmFaceCancel(int i);

    void setFormatMode(int i);

    void setNotifyCiuAutoLightStatus(boolean z);

    void setRegHint(int i);

    void setRegisterRequestMulti(int i, int i2, int i3);

    void setStartRegFlag(int i);

    void setStartRegFlow(int i);

    void setUid(int i);

    void setVideoOutputMode(int i);

    void setVideoTimeLenMode(int i);
}
