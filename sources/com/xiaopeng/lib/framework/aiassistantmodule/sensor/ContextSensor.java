...
public class ContextSensor implements IContextSensor {
    ...
    public void getSensorValue(String str, String str2, ISensorCallback iSensorCallback) {
        ...
        ArrayMap<String, ISensorCallback> arrayMap = this.mSensorCallbackArrayMap;
        arrayMap.put(str + str2, iSensorCallback);
    ...
    private void responseSensorValue(String str, String str2, String str3) {
        ...
        if (arrayMap.containsKey(str + str2)) {
            ArrayMap<String, ISensorCallback> arrayMap2 = this.mSensorCallbackArrayMap;
            arrayMap2.get(str + str2).onSensorReponse(str, str2, str3);
            ArrayMap<String, ISensorCallback> arrayMap3 = this.mSensorCallbackArrayMap;
            arrayMap3.remove(str + str2);
        }
    }
