...
public class EspController extends AbstractController implements IEspController {
    ...
    @Override // com.xiaopeng.lib.framework.moduleinterface.carcontroller.IEspController
    public boolean isAvhFault() {
        return false;
    }

    @Override // com.xiaopeng.lib.framework.moduleinterface.carcontroller.IEspController
    public boolean isEpbWarningLampOn() {
        return false;
    }

    @Override // com.xiaopeng.lib.framework.moduleinterface.carcontroller.IEspController
    public boolean isEpsWarningLampOn() {
        return false;
    }

    @Override // com.xiaopeng.lib.framework.moduleinterface.carcontroller.IEspController
    public boolean isEspFault() {
        return false;
    }

    @Override // com.xiaopeng.lib.framework.moduleinterface.carcontroller.IEspController
    public boolean isHdcFault() {
        return false;
    }

    @Override // com.xiaopeng.lib.framework.moduleinterface.carcontroller.IEspController
    public void setHDC(boolean z) {
    }
