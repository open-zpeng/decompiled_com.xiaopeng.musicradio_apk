...
public class IpcServiceImpl implements IIpcService {
    ...
    public void registerIpcClient(a aVar) {
        ...
        if (aVar != null) {
            aVar.a(AppInfoUtils.getProcessName(), this.mIPCCallback);
    ...
    private IpcServiceImpl() {
        ...
        this.mIPCCallback = new b.a() { // from class: com.xiaopeng.lib.framework.ipcmodule.IpcServiceImpl.1
            ...
            public void onReceive(IpcMessage ipcMessage) {
                Log.i(IpcServiceImpl.TAG, "onReceive:\t sender " + ipcMessage.a() + "\thasSubscriberForEvent:\t" + EventBus.getDefault().hasSubscriberForEvent(IIpcService.IpcMessageEvent.class));
                IIpcService.IpcMessageEvent ipcMessageEvent = new IIpcService.IpcMessageEvent();
                ipcMessageEvent.setPayloadData(ipcMessage.c());
                ipcMessageEvent.setMsgID(ipcMessage.b());
                ipcMessageEvent.setSenderPackageName(ipcMessage.a());
        ...
        this.mServiceConnection = new ServiceConnection() { // from class: com.xiaopeng.lib.framework.ipcmodule.IpcServiceImpl.4
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                ...
                synchronized (IpcServiceImpl.class) {
                    IpcServiceImpl.this.ipcService = a.AbstractBinderC0123a.a(iBinder);
                    try {
