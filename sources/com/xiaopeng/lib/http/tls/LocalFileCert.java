...
public class LocalFileCert {
                ...
                try {
                    ...
                    try {
                        try {
                            ...
                            abr.a().a(6005, e.getLocalizedMessage());
                            e.printStackTrace();
                        }
                        try {
                            open.close();
                    ...
                    abr.a().a(6005, e2.getLocalizedMessage());
                    e2.printStackTrace();
                    return null;
                }
            }
            ...
            if (sKeyManagers != null) {
                ...
                try {
                    if (SecurityCommon.checkSystemUid(context)) {
                        ...
                        certificate = ((ISystemDelegate) Module.get(bhu.class).get(ISystemDelegate.class)).getCertificate();
                    }
    ...
    public static SSLSocketFactory getTLS2SocketFactory(Context context) {
        try {
            ...
            abr.a().a(6006, e.getLocalizedMessage());
            e.printStackTrace();
            return null;
        }
    }
