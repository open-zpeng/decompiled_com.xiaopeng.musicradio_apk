...
import com.xiaopeng.musicradio.WebViewVuiObserver;
import com.xiaopeng.speech.vui.constants.VuiConstants;
/* compiled from: WebViewVuiObserver_Stub.java */
/* loaded from: classes.dex */
public class n extends Binder implements IInterface {
    public WebViewVuiObserver a = new WebViewVuiObserver();
    public m b = new m();
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
        if (i == 1598968902) {
            parcel2.writeString("com.xiaopeng.musicradio.WebViewVuiObserver");
            return true;
        }
        switch (i) {
            case 0:
                parcel.enforceInterface("com.xiaopeng.musicradio.WebViewVuiObserver");
