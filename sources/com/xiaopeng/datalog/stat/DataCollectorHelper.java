...
public class DataCollectorHelper {
    ...
    private ServiceConnection mConnection = new ServiceConnection() { // from class: com.xiaopeng.datalog.stat.DataCollectorHelper.2
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            DataCollectorHelper.this.remoteService = acf.a.a(iBinder);
    ...
    */
    public void uploadLogOrigin(java.lang.String r3, java.lang.String r4) {
        ...
        L19:
            if (r0 != 0) goto L53
            java.lang.Class<abh> r0 = defpackage.abh.class
    ...
    */
    ...
    public void dumpCan2File() {
        ...
        abo.a().a("candata", ZipUtils.compressForGzipAndBase64NoWrap(buildCanDataZipJson()), this.mContext);
    ...
    public void dumpCdu2File() {
        ...
        abo.a().a("cdudata", ZipUtils.compressForGzipAndBase64NoWrap(buildCduDataZipJson()), this.mContext);
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void uploadCduWithFiles(final abk abkVar, final List<String> list) {
        ...
        ThreadUtils.postBackground(new Runnable() { // from class: com.xiaopeng.datalog.stat.DataCollectorHelper.5
            ...
            public void run() {
                ...
                abkVar.put("address", generateUploadInfos[0]);
                String json = abkVar.toJson();
