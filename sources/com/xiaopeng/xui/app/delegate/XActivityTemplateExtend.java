...
public abstract class XActivityTemplateExtend implements XActivityLifecycle, XActivityTemplate {
    ...
    private static class PanelImpl extends BaseTemplate implements XActivityTemplate.Panel {
        ...
        void initWindowAttributes(XActivityWindowAttributes xActivityWindowAttributes) {
            ...
            int dip2px = XuiUtils.dip2px(this.mActivity, bip.e.x_compat_app_panel_x);
            int dip2px2 = XuiUtils.dip2px(this.mActivity, bip.e.x_compat_app_panel_y);
            int dip2px3 = XuiUtils.dip2px(this.mActivity, bip.e.x_compat_app_panel_width);
            int dip2px4 = XuiUtils.dip2px(this.mActivity, bip.e.x_compat_app_panel_height);
            switch (i) {
                case 1:
