...
public class XCircularProgressIndeterminateDrawable extends Drawable {
    ...
    private void updateAttr(Resources resources, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, bip.l.XCircularProgressIndeterminateDrawable, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, bip.l.XCircularProgressIndeterminateDrawable);
        }
        this.mStartColor = obtainAttributes.getColor(bip.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_startColor, resources.getColor(17170445, theme));
        this.mEndColor = obtainAttributes.getColor(bip.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_endColor, resources.getColor(bip.d.x_circular_progress_primary_color, theme));
        this.mStrokeWidth = obtainAttributes.getDimension(bip.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_strokeWidth, 0.0f);
        this.mEnableLight = obtainAttributes.getBoolean(bip.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_enable_light, false);
        this.mInset = obtainAttributes.getDimensionPixelSize(bip.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_inset, 0);
        this.mLightRadius = obtainAttributes.getDimensionPixelOffset(bip.l.XCircularProgressIndeterminateDrawable_progress_indeterminate_light_radius, 0);
