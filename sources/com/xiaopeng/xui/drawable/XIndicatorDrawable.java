...
public final class XIndicatorDrawable extends Drawable {
    ...
    public void inflateAttrs(Resources resources, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, bip.l.XSegmented, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, bip.l.XSegmented);
        }
        this.mIndicatorColorRes = obtainAttributes.getResourceId(bip.l.XSegmented_segment_indicator_color, bip.d.x_segment_indicator_color);
        this.mIndicatorType = obtainAttributes.getInt(bip.l.XSegmented_segment_indicator_type, 0);
        onConfigurationChanged(resources, theme);
        if (this.mIndicatorType == 1) {
            this.mIndicatorPercent = obtainAttributes.getFloat(bip.l.XSegmented_segment_line_width_percent, 1.0f);
            this.mIndicatorHeight = dp(resources, 4);
            this.mIndicatorPaddingBottom = obtainAttributes.getDimension(bip.l.XSegmented_segment_line_padding_bottom, dp(resources, 6));
    ...
    public void onConfigurationChanged(Resources resources, Resources.Theme theme) {
        ...
        this.mDefaultColor = resources.getColor(bip.d.x_segment_indicator_color, theme);
        setPaintColor();
