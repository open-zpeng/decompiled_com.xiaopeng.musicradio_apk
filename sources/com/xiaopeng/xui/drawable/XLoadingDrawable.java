...
public class XLoadingDrawable extends Drawable {
    ...
    private int mColorId = bip.d.x_theme_text_01;
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, bip.l.XLoadingDrawable);
        this.mColorId = obtainAttributes.getResourceId(bip.l.XLoadingDrawable_loading_color, bip.d.x_theme_text_01);
        this.mColor = resources.getColor(this.mColorId, theme);
        setType(obtainAttributes.getInt(bip.l.XLoadingDrawable_loading_type, 3));
