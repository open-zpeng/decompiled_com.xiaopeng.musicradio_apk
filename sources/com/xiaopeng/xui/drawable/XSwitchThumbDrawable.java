...
public class XSwitchThumbDrawable extends Drawable {
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, bip.l.XSwitchThumbDrawable, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, bip.l.XSwitchThumbDrawable);
        }
        this.mWidth = obtainAttributes.getDimensionPixelSize(bip.l.XSwitchThumbDrawable_switch_thumb_width, 44);
        this.mHeight = obtainAttributes.getDimensionPixelSize(bip.l.XSwitchThumbDrawable_switch_thumb_height, 44);
        this.mPadding = obtainAttributes.getDimension(bip.l.XSwitchThumbDrawable_switch_thumb_padding, 4.0f);
        this.mThumbRoundRadius = obtainAttributes.getDimensionPixelSize(bip.l.XSwitchThumbDrawable_switch_thumb_round_radius, 7);
        this.mIndicatorRoundRadius = obtainAttributes.getDimensionPixelSize(bip.l.XSwitchThumbDrawable_switch_thumb_indicator_round_radius, 3);
        float dimension = obtainAttributes.getDimension(bip.l.XSwitchThumbDrawable_switch_thumb_indicator_width, 6.0f);
        float dimension2 = obtainAttributes.getDimension(bip.l.XSwitchThumbDrawable_switch_thumb_indicator_height, 18.0f);
        ...
        this.mIndicatorColors = obtainAttributes.getColorStateList(bip.l.XSwitchThumbDrawable_switch_thumb_indicator_color);
        ...
        this.mThumbColors = obtainAttributes.getColorStateList(bip.l.XSwitchThumbDrawable_switch_thumb_color);
