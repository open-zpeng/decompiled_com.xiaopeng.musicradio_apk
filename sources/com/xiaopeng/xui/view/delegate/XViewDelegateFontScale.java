...
public class XViewDelegateFontScale extends XViewDelegatePart {
    ...
    public static XViewDelegateFontScale create(TextView textView, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = textView.getContext().obtainStyledAttributes(attributeSet, bip.l.XFontSize, i, i2);
        boolean z2 = obtainStyledAttributes.getBoolean(bip.l.XFontSize_x_dynamic_font_scale_change_enable, true);
