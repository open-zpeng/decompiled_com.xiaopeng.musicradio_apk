...
class XViewDelegateImpl extends XViewDelegate {
    ...
    public XViewDelegateImpl(View view, AttributeSet attributeSet, int i, int i2, Object obj) {
        ...
        this.mThemeViewModel = acv.a(view.getContext(), attributeSet, i, i2, obj);
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        acv acvVar = this.mThemeViewModel;
        if (acvVar != null) {
            acvVar.a(this.mView, configuration);
        }
