...
public class XTabLayout extends XLinearLayout implements bic {
    ...
    public XTabLayout(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2 == 0 ? bip.k.XTabLayoutAppearance : i2);
        this.MARGIN_DAY = 0;
        ...
        getContext().getTheme();
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, bip.l.XTabLayout, i == 0 ? bip.k.XTabLayoutAppearance : i, bip.k.XTabLayoutAppearance);
        this.mTitleString = obtainStyledAttributes.getTextArray(bip.l.XTabLayout_titles);
        this.mTitleTextSize = obtainStyledAttributes.getDimension(bip.l.XTabLayout_titleTextSize, 35.0f);
        final XFontScaleHelper create = XFontScaleHelper.create(obtainStyledAttributes, bip.l.XTabLayout_titleTextSize);
        ...
        this.mTitleTextColorStateList = obtainStyledAttributes.getColorStateList(bip.l.XTabLayout_titleTextColorStateList);
        int integer = obtainStyledAttributes.getInteger(bip.l.XTabLayout_selectTab, 0);
        this.mIndicatorWidth = obtainStyledAttributes.getDimension(bip.l.XTabLayout_indicatorWidth, 0.0f);
        this.mIndicatorWidthPercent = obtainStyledAttributes.getFraction(bip.l.XTabLayout_indicatorWidthPercent, 1, 1, 0.7f);
        this.mIndicatorMaxHeight = obtainStyledAttributes.getDimension(bip.l.XTabLayout_indicatorMaxHeight, dp(4));
        this.mIndicatorMinHeight = obtainStyledAttributes.getDimension(bip.l.XTabLayout_indicatorMinHeight, dp(2));
        this.mIndicatorHeight = this.mIndicatorMaxHeight;
        this.mIndicatorMarginBottom = obtainStyledAttributes.getDimension(bip.l.XTabLayout_indicatorMarginBottom, dp(6));
        this.mIndicatorColor = obtainStyledAttributes.getResourceId(bip.l.XTabLayout_indicatorColor, bip.d.x_theme_primary_normal);
        this.mIndicatorColorFrom = obtainStyledAttributes.getColor(bip.l.XTabLayout_indicatorColorFrom, -1);
        this.mIndicatorColorTo = obtainStyledAttributes.getColor(bip.l.XTabLayout_indicatorColorTo, -1);
        this.mIndicatorShadowColor = obtainStyledAttributes.getColor(bip.l.XTabLayout_indicatorShadowColor, -15880455);
        this.mIndicatorShadowRadius = obtainStyledAttributes.getDimension(bip.l.XTabLayout_indicatorShadowRadius, dp(4));
        this.mIndicatorColor2 = obtainStyledAttributes.getResourceId(bip.l.XTabLayout_indicatorColor2, bip.d.x_table_indicator_color);
        this.mIndicatorShadowColor2 = obtainStyledAttributes.getColor(bip.l.XTabLayout_indicatorShadowColor2, -15880455);
        this.mIndicatorShadowRadius2 = obtainStyledAttributes.getDimension(bip.l.XTabLayout_indicatorShadowRadius2, dp(4));
        this.mIndicatorAnimatorEnable = obtainStyledAttributes.getBoolean(bip.l.XTabLayout_indicatorAnimatorEnable, true);
        this.mTitleTextColorRes = obtainStyledAttributes.getResourceId(bip.l.XTabLayout_titleTextColorStateList, -1);
        this.mTabsBarStyle = obtainStyledAttributes.getBoolean(bip.l.XTabLayout_tabsBarStyle, false);
        this.mTabCustomBackground = obtainStyledAttributes.getBoolean(bip.l.XTabLayout_tabCustomBackground, false);
        this.mPaddingNight = obtainStyledAttributes.getDimensionPixelSize(bip.l.XTabLayout_tabPaddingNight, dp(40));
        this.mIndicatorDayNightDiff = obtainStyledAttributes.getBoolean(bip.l.XTabLayout_indicatorDayNightDiff, false);
        int resourceId = obtainStyledAttributes.getResourceId(bip.l.XTabLayout_tabLayoutIcons, 0);
        if (resourceId != 0) {
        ...
        this.mIconVuiLabels = obtainStyledAttributes.getTextArray(bip.l.XTabLayout_tabLayoutVuiLabels);
        setGravity(17);
    ...
    public int addTab(CharSequence charSequence, int i) {
        TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(bip.i.x_tab_layout_title_view, (ViewGroup) this, false);
