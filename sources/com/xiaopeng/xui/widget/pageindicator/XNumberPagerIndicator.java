...
public class XNumberPagerIndicator extends XViewPagerIndicatorAbs {
    ...
    public void init() {
        super.init();
        int dimensionPixelOffset = getContext().getResources().getDimensionPixelOffset(bip.e.x_pager_indicator_number_padding);
        setPadding(dimensionPixelOffset, 0, dimensionPixelOffset, 0);
        this.mChildViewSize = getContext().getResources().getDimensionPixelSize(bip.e.x_pager_indicator_view_size);
        this.mFormat = getContext().getString(bip.j.x_number_indicator_desc_format);
    }
    ...
    public void populateData(int i) {
        if (this.mTextView == null) {
            ...
            this.mTextView.setTextAppearance(bip.k.XNumberIndicatorSelectedTextStyle);
    ...
    private void refreshText() {
        if (this.mTextView != null) {
            ...
            TextAppearanceSpan textAppearanceSpan = new TextAppearanceSpan(getContext(), bip.k.XNumberIndicatorTextStyle);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (acs.b(configuration)) {
            ...
            if (textView != null) {
                textView.setTextAppearance(bip.k.XNumberIndicatorSelectedTextStyle);
            }
            refreshText();
        }
    }
