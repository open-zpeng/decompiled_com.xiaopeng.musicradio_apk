...
public class XDotPagerIndicator extends XViewPagerIndicatorAbs {
    ...
    public void init() {
        super.init();
        this.mDotSize = getContext().getResources().getDimensionPixelSize(bip.e.x_pager_indicator_view_size);
        int dimensionPixelOffset = getContext().getResources().getDimensionPixelOffset(bip.e.x_pager_indicator_dot_padding);
    ...
    protected View generateIndicator() {
        ...
        xImageView.setImageResource(bip.f.x_dot_indicator_bg);
        ...
        if (acs.b(configuration)) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt instanceof ImageView) {
                    ((ImageView) childAt).setImageResource(bip.f.x_dot_indicator_bg);
                }
            }
        }
    }
