...
public class XCircularProgressBar extends ProgressBar {
    ...
    private static final int[] STATE_PLAYING_STOP = {bip.c.progress_state_playing_stop};
    private static final int[] STATE_PLAYING_PAUSE = {bip.c.progress_state_playing_pause};
    private static final int[] STATE_PAUSED = {bip.c.progress_state_paused};
    private static final int[] STATE_START_DOWNLOAD = {bip.c.progress_state_start_download};
    ...
    public XCircularProgressBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, bip.k.XProgressBar_Circular_Medium);
    }

    public XCircularProgressBar(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, bip.k.XProgressBar_Circular_Medium);
    }
    ...
    private void init(AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, bip.l.XCircularProgressBar, i, i2);
        this.mEnableIndicator = obtainStyledAttributes.getBoolean(bip.l.XCircularProgressBar_progress_enableIndicator, false);
        this.mIndicatorType = obtainStyledAttributes.getInt(bip.l.XCircularProgressBar_progress_indicatorType, 0);
        this.mInset = obtainStyledAttributes.getDimensionPixelSize(bip.l.XCircularProgressBar_progress_inset, 0);
        this.mStrokeWidth = obtainStyledAttributes.getDimensionPixelOffset(bip.l.XCircularProgressBar_progress_strokeWidth, 0);
        boolean z = obtainStyledAttributes.getBoolean(bip.l.XCircularProgressBar_android_enabled, true);
        this.mLightRadius = obtainStyledAttributes.getDimensionPixelOffset(bip.l.XCircularProgressBar_progress_light_radius, 0);
        this.mIndicatorPlay = obtainStyledAttributes.getDrawable(bip.l.XCircularProgressBar_progress_indicator_play);
        this.mIndicatorPause = obtainStyledAttributes.getDrawable(bip.l.XCircularProgressBar_progress_indicator_pause);
        this.mIndicatorStop = obtainStyledAttributes.getDrawable(bip.l.XCircularProgressBar_progress_indicator_stop);
        this.mIndicatorStart = obtainStyledAttributes.getDrawable(bip.l.XCircularProgressBar_progress_indicator_start);
        this.mIndicatorPlayId = obtainStyledAttributes.getResourceId(bip.l.XCircularProgressBar_progress_indicator_play, 0);
        this.mIndicatorPauseId = obtainStyledAttributes.getResourceId(bip.l.XCircularProgressBar_progress_indicator_pause, 0);
        this.mIndicatorStopId = obtainStyledAttributes.getResourceId(bip.l.XCircularProgressBar_progress_indicator_stop, 0);
        this.mIndicatorStartId = obtainStyledAttributes.getResourceId(bip.l.XCircularProgressBar_progress_indicator_start, 0);
        this.mIndeterminateDrId = obtainStyledAttributes.getResourceId(bip.l.XCircularProgressBar_android_indeterminateDrawable, 0);
        this.mProgressDrawableId = obtainStyledAttributes.getResourceId(bip.l.XCircularProgressBar_android_progressDrawable, 0);
        ...
        if (xViewDelegate != null && xViewDelegate.getThemeViewModel() != null) {
            this.mXViewDelegate.getThemeViewModel().a(new acv.a() { // from class: com.xiaopeng.xui.widget.-$$Lambda$JVfRJeX6AYq8xWz8g0m1ft-Uuzc
