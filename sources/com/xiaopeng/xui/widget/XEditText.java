...
public class XEditText extends k implements VuiView {
    ...
    private void init(AttributeSet attributeSet, int i) {
        if (!isInEditMode()) {
            this.mXViewDelegate = XViewDelegate.create(this, attributeSet, i, 0, acv.a("extra_global", "scrollbarThumbVertical"));
        }
