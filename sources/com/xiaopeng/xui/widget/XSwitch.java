...
public class XSwitch extends XCompoundButton implements ValueAnimator.AnimatorUpdateListener {
    ...
    public XSwitch(Context context, AttributeSet attributeSet) {
        ...
        this.PADDING_TOP = getResources().getDimension(bip.e.x_switch_padding_top);
        this.PADDING_LEFT = getResources().getDimension(bip.e.x_switch_padding_start);
    ...
    private void init() {
        ...
        setButtonDrawable(bip.f.x_switch_drawable);
    ...
    private void initColor() {
        ...
        this.mBgEnableOffNormalColorStart = getColor(bip.d.x_switch_bg_off_enable_normal_start_color);
        this.mBgEnableOffNormalColorEnd = getColor(bip.d.x_switch_bg_off_enable_normal_end_color);
        this.mBgEnableOffPressedColorStart = getColor(bip.d.x_switch_bg_off_enable_pressed_start_color);
        this.mBgEnableOffPressedColorEnd = getColor(bip.d.x_switch_bg_off_enable_pressed_end_color);
        this.mBgEnableOnNormalColorStart = getColor(bip.d.x_switch_bg_on_enable_normal_start_color);
        this.mBgEnableOnNormalColorEnd = getColor(bip.d.x_switch_bg_on_enable_normal_end_color);
        this.mBgEnableOnPressedColorStart = getColor(bip.d.x_switch_bg_on_enable_pressed_start_color);
        this.mBgEnableOnPressedColorEnd = getColor(bip.d.x_switch_bg_on_enable_pressed_end_color);
        this.mBgDisableOffColorStart = getColor(bip.d.x_switch_bg_off_disable_start_color);
        this.mBgDisableOffColorEnd = getColor(bip.d.x_switch_bg_off_disable_end_color);
        this.mBgDisableOnColorStart = getColor(bip.d.x_switch_bg_on_disable_start_color);
        this.mBgDisableOnColorEnd = getColor(bip.d.x_switch_bg_on_disable_end_color);
        this.mCircleOutEnableOffColorStart = getColor(bip.d.x_switch_circle_out_off_enable_start_color);
        this.mCircleOutEnableOffColorEnd = getColor(bip.d.x_switch_circle_out_off_enable_end_color);
        this.mCircleOutEnableOnColorStart = getColor(bip.d.x_switch_circle_out_on_enable_start_color);
        this.mCircleOutEnableOnColorEnd = getColor(bip.d.x_switch_circle_out_on_enable_end_color);
        this.mCircleOutDisableOffColorStart = getColor(bip.d.x_switch_circle_out_off_disable_start_color);
        this.mCircleOutDisableOffColorEnd = getColor(bip.d.x_switch_circle_out_off_disable_end_color);
        this.mCircleOutDisableOnColorStart = getColor(bip.d.x_switch_circle_out_on_disable_start_color);
        this.mCircleOutDisableOnColorEnd = getColor(bip.d.x_switch_circle_out_on_disable_end_color);
        this.mCircleOutShadowColor = getColor(bip.d.x_switch_circle_out_shadow_color);
        this.mCircleInnerEnableColorStart = getColor(bip.d.x_switch_circle_inner_enable_start_color);
        this.mCircleInnerEnableColorEnd = getColor(bip.d.x_switch_circle_inner_enable_end_color);
        this.mCircleInnerDisableColorStart = getColor(bip.d.x_switch_circle_inner_disable_start_color);
        this.mCircleInnerDisableColorEnd = getColor(bip.d.x_switch_circle_inner_disable_end_color);
        this.mVerticalEnableOffColor = getColor(bip.d.x_switch_vertical_off_enable_color);
        this.mVerticalEnableOnColor = getColor(bip.d.x_switch_vertical_on_enable_color);
        this.mVerticalDisableOffColor = getColor(bip.d.x_switch_vertical_off_disable_color);
        this.mVerticalDisableOnColor = getColor(bip.d.x_switch_vertical_on_disable_color);
        changeParams();
    }
