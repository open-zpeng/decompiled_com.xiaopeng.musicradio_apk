...
public class IndicatorDrawable extends Drawable implements Drawable.Callback {
    ...
    public void inflateAttr(Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = theme.obtainStyledAttributes(attributeSet, bip.l.XSlider, 0, i);
        } else {
            obtainStyledAttributes = theme.obtainStyledAttributes(i, bip.l.XSlider);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_text_tag_bg)) {
            this.mTagBgResId = obtainStyledAttributes.getResourceId(bip.l.XSlider_slider_text_tag_bg, 0);
        }
    ...
    public void refreshUI(Resources resources, Resources.Theme theme) {
        Drawable a = fb.a(resources, this.mTagBgResId, theme);
