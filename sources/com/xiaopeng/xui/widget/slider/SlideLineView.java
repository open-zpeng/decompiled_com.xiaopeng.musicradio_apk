...
class SlideLineView extends XView {
    ...
    private void readStyleAttrs(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bip.l.SlideLineView, 0, i);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(i, bip.l.SlideLineView);
        }
        this.bgLineColorUnSelect = obtainStyledAttributes.getColor(bip.l.SlideLineView_slider_line_un_select, this.bgLineColorUnSelect);
        this.bgLineColorSelect = obtainStyledAttributes.getColor(bip.l.SlideLineView_slider_line_select, this.bgLineColorSelect);
