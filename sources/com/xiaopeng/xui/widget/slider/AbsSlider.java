...
public abstract class AbsSlider extends XViewGroup implements bic {
    ...
    public AbsSlider(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.itemCount = 30;
        this.mOrientation = 0;
        this.mTickMarkStyleRes = bip.k.XSliderLine;
        ...
        if (!isInEditMode()) {
            ...
            if (XThemeManager.isThemeChanged(configuration)) {
                ...
                if (this.mThumbResId != 0) {
                    this.mThumb = es.a(getContext(), this.mThumbResId);
                }
            }
        }
        invalidate();
    ...
    private void initView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, bip.l.XSlider, i, i2);
        this.unit = obtainStyledAttributes.getString(bip.l.XSlider_slider_unit);
        this.startIndex = obtainStyledAttributes.getInteger(bip.l.XSlider_slider_start_index, 0);
        this.mStep = obtainStyledAttributes.getInteger(bip.l.XSlider_slider_step, 1);
        this.initIndex = obtainStyledAttributes.getInteger(bip.l.XSlider_slider_init_index, -1);
        this.endIndex = obtainStyledAttributes.getInteger(bip.l.XSlider_slider_end_index, 100);
        this.upperLimit = obtainStyledAttributes.getInteger(bip.l.XSlider_slider_upper_limit, Integer.MIN_VALUE);
        this.decimal = obtainStyledAttributes.getInteger(bip.l.XSlider_slider_index_decimal, 0);
        this.prefixUnit = obtainStyledAttributes.getString(bip.l.XSlider_slider_unit_prefix);
        this.accuracy = obtainStyledAttributes.getFloat(bip.l.XSlider_slider_accuracy, 0.0f);
    ...
    private void readStyleAttrs(AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, bip.l.XSlider, 0, i);
        } else {
            obtainStyledAttributes = getContext().obtainStyledAttributes(i, bip.l.XSlider);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_bg_color)) {
            this.bgNightColor = obtainStyledAttributes.getColor(bip.l.XSlider_slider_bg_color, this.bgNightColor);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_bg_line_color)) {
            this.bgLineColorSelect = obtainStyledAttributes.getColor(bip.l.XSlider_slider_bg_line_color, this.bgLineColorSelect);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_background)) {
            this.customBackground = obtainStyledAttributes.getColor(bip.l.XSlider_slider_background, 0);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_hide_pop)) {
            this.hidePop = obtainStyledAttributes.getBoolean(bip.l.XSlider_slider_hide_pop, false);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_dismiss_pop)) {
            this.dismissPop = obtainStyledAttributes.getBoolean(bip.l.XSlider_slider_dismiss_pop, false);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_item_count)) {
            this.itemCount = obtainStyledAttributes.getInteger(bip.l.XSlider_slider_item_count, 30);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_orientation)) {
            this.mOrientation = obtainStyledAttributes.getInt(bip.l.XSlider_slider_orientation, 0);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_thumb)) {
            this.mThumbResId = obtainStyledAttributes.getResourceId(bip.l.XSlider_slider_thumb, 0);
            if (this.mThumbResId != 0) {
                this.mThumb = es.a(getContext(), this.mThumbResId);
            } else {
                this.mThumb = null;
        ...
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_progress_color_start)) {
            this.mProgressLeftColor = obtainStyledAttributes.getColor(bip.l.XSlider_slider_progress_color_start, this.mProgressLeftColor);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_progress_color_end)) {
            this.mProgressRightColor = obtainStyledAttributes.getColor(bip.l.XSlider_slider_progress_color_end, this.mProgressRightColor);
        }
        if (obtainStyledAttributes.hasValueOrEmpty(bip.l.XSlider_slider_tickMarkStyle)) {
            this.mTickMarkStyleRes = obtainStyledAttributes.getResourceId(bip.l.XSlider_slider_tickMarkStyle, bip.k.XSliderLine);
        }
        obtainStyledAttributes.recycle();
    }
