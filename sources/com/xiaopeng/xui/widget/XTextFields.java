...
public class XTextFields extends XTextInput implements View.OnClickListener, bic {
    ...
    public XTextFields(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bip.l.XTextFields);
        boolean z = obtainStyledAttributes.getBoolean(bip.l.XTextFields_text_fields_password_enabled, false);
    ...
    protected void initView() {
        LayoutInflater.from(getContext()).inflate(bip.i.x_text_fields, this);
        this.mResetView = (ImageButton) findViewById(bip.g.x_text_fields_reset);
        this.mPassWordView = (ImageButton) findViewById(bip.g.x_text_fields_pass);
        this.mEditText = (EditText) findViewById(bip.g.x_text_fields_edit);
        this.mErrorTextView = (TextView) findViewById(bip.g.x_text_fields_error);
        this.mStatusView = findViewById(bip.g.x_text_fields_line);
    ...
    public void onClick(View view) {
        if (view.getId() == bip.g.x_text_fields_pass) {
    ...
    public bin onBuildVuiElement(String str, bia biaVar) {
        if (this.mPassWordView instanceof VuiView) {
            VuiUtils.setStatefulButtonAttr((VuiView) this.mPassWordView, !this.mPasswordCheck ? 1 : 0, new String[]{this.mContext.getString(bip.j.vui_label_hide_password), this.mContext.getString(bip.j.vui_label_display_password)});
            return null;
        }
        return null;
    }
    ...
    public boolean onVuiElementEvent(final View view, bio bioVar) {
        ...
        if (view.getId() == this.mPassWordView.getId()) {
            ...
            if (!(this.mPasswordCheck && str.equals(this.mContext.getString(bip.j.vui_label_hide_password))) && (this.mPasswordCheck || !str.equals(this.mContext.getString(bip.j.vui_label_display_password)))) {
