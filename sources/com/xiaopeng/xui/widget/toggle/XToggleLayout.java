...
public class XToggleLayout extends XRelativeLayout implements Checkable {
    ...
    public XToggleLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, bip.k.XToggleLayout_Fill);
    }

    public XToggleLayout(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, bip.k.XToggleLayout_Fill);
    }
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        setClickable(true);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bip.l.XToggleLayout, i, i2);
        this.mChecked = obtainStyledAttributes.getBoolean(bip.l.XToggleLayout_android_checked, false);
        this.mEnabled = obtainStyledAttributes.getBoolean(bip.l.XToggleLayout_android_enabled, true);
        super.setEnabled(this.mEnabled);
        this.mDisabledAlpha = obtainStyledAttributes.getFloat(bip.l.XToggleLayout_android_disabledAlpha, 0.5f);
        setLoading(obtainStyledAttributes.getBoolean(bip.l.XToggleLayout_loading, false));
        this.mBgId = obtainStyledAttributes.getResourceId(bip.l.XToggleLayout_android_background, 0);
        obtainStyledAttributes.recycle();
        if (this.mXViewDelegate != null && this.mXViewDelegate.getThemeViewModel() != null) {
            this.mXViewDelegate.getThemeViewModel().a(new acv.a() { // from class: com.xiaopeng.xui.widget.toggle.-$$Lambda$6g2JO4-xGs4DyGn2Xl_cnUiW-QI
