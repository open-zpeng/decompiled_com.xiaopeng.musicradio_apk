...
public class XTextToggle extends XToggleLayout {
    ...
    public XTextToggle(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, bip.k.XToggleLayout_Fill_TextToggle);
    }

    public XTextToggle(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, bip.k.XToggleLayout_Fill_TextToggle);
    }

    public XTextToggle(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, bip.l.XTextToggle, i, i2);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(bip.l.XTextToggle_android_textSize, 15);
        final XFontScaleHelper create = XFontScaleHelper.create(obtainStyledAttributes, bip.l.XTextToggle_android_textSize);
        ...
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(bip.l.XTextToggle_android_textColor);
        this.mTextColorResId = obtainStyledAttributes.getResourceId(bip.l.XTextToggle_android_textColor, 0);
        ...
        Drawable drawable = obtainStyledAttributes.getDrawable(bip.l.XTextToggle_android_drawableStart);
        int dimensionPixelSize2 = obtainStyledAttributes.getDimensionPixelSize(bip.l.XTextToggle_android_drawablePadding, 0);
        if (drawable != null) {
        ...
        this.mDrawableStartResId = obtainStyledAttributes.getResourceId(bip.l.XTextToggle_android_drawableStart, 0);
        this.mTextOn = obtainStyledAttributes.getText(bip.l.XTextToggle_android_textOn);
        this.mTextOff = obtainStyledAttributes.getText(bip.l.XTextToggle_android_textOff);
        syncTextState();
