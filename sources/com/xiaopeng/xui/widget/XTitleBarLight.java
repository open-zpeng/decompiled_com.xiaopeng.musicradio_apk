...
public class XTitleBarLight extends XRelativeLayout implements View.OnClickListener, bic {
    ...
    public XTitleBarLight(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(bip.i.x_titlebarlight, this);
        initView();
        this.mSparsePadding = (int) getResources().getDimension(bip.e.x_title_bar_light_sparse_padding);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bip.l.XTitleBarLight);
        setTitle(obtainStyledAttributes.getString(bip.l.XTitleBarLight_title_text));
        setMainAction(obtainStyledAttributes.getInt(bip.l.XTitleBarLight_title_main_action, 0));
        setTitleType(obtainStyledAttributes.getInt(bip.l.XTitleBarLight_title_text_type, 0));
        int resourceId = obtainStyledAttributes.getResourceId(bip.l.XTitleBarLight_title_right_action_layout, 0);
        if (resourceId > 0) {
    ...
    public void onClick(View view) {
        ...
        } else if (id != bip.g.x_titlebar_btn_back || (onTitleBarClickListener = this.mOnTitleBarClickListener) == null) {
        } else {
