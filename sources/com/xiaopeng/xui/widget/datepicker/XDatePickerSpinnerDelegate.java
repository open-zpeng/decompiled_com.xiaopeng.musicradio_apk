...
public class XDatePickerSpinnerDelegate extends XDatePicker.AbstractXDatePickerDelegate {
    ...
    public XDatePickerSpinnerDelegate(XDatePicker xDatePicker, Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bip.l.XDatePicker, i, i2);
        boolean z = obtainStyledAttributes.getBoolean(bip.l.XDatePicker_dp_spinnersShown, true);
        int i3 = obtainStyledAttributes.getInt(bip.l.XDatePicker_dp_startYear, DEFAULT_START_YEAR);
        int i4 = obtainStyledAttributes.getInt(bip.l.XDatePicker_dp_endYear, DEFAULT_END_YEAR);
        String string = obtainStyledAttributes.getString(bip.l.XDatePicker_dp_minDate);
        String string2 = obtainStyledAttributes.getString(bip.l.XDatePicker_dp_maxDate);
        int resourceId = obtainStyledAttributes.getResourceId(bip.l.XDatePicker_dp_xDatePickerLayout, bip.i.x_date_picker_layout);
        ...
        this.mSpinners = (LinearLayout) this.mXDelegator.findViewById(bip.g.pickers);
        reorderSpinners(new XNumberPicker[]{(XNumberPicker) this.mXDelegator.findViewById(bip.g.picker1), (XNumberPicker) this.mXDelegator.findViewById(bip.g.picker2), (XNumberPicker) this.mXDelegator.findViewById(bip.g.picker3)});
    ...
    private void updateSpinners() {
        ...
        while (i < this.mCurrentDate.getActualMaximum(5)) {
            int i2 = i + 1;
            strArr[i] = this.mContext.getResources().getString(bip.j.x_date_picker_day, Integer.valueOf(i2));
            i = i2;
        }
        ...
        for (int i3 = 0; i3 < strArr2.length; i3++) {
            strArr2[i3] = this.mContext.getResources().getString(bip.j.x_date_picker_year, Integer.valueOf(this.mYearSpinner.getMinValue() + i3));
        }
