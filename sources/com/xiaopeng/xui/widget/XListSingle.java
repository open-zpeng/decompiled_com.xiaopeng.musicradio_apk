...
public class XListSingle extends XRelativeLayout {
    ...
    public XListSingle(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(bip.i.x_list_single, this);
        initView();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bip.l.XListSingle);
        setText(obtainStyledAttributes.getString(bip.l.XListSingle_list_single_text));
        int resourceId = obtainStyledAttributes.getResourceId(bip.l.XListSingle_list_single_left, -1);
        if (resourceId != -1) {
        ...
        int resourceId2 = obtainStyledAttributes.getResourceId(bip.l.XListSingle_list_single_right, -1);
        if (resourceId2 != -1) {
        ...
        int resourceId3 = obtainStyledAttributes.getResourceId(bip.l.XListSingle_list_single_tag_icon, -1);
        if (resourceId3 != -1) {
            setTagIcon(resourceId3);
        }
        boolean z = obtainStyledAttributes.getBoolean(bip.l.XListSingle_list_single_tag, false);
        showIconTag(z);
        this.mLeftRightTouchFull = obtainStyledAttributes.getInt(bip.l.XListSingle_list_single_left_right_touch_full, 0);
        obtainStyledAttributes.recycle();
        if (resourceId2 != -1) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.mText.getLayoutParams();
            marginLayoutParams.setMarginEnd((int) getResources().getDimension(z ? bip.e.x_list_tv_has_tag_margin_end : bip.e.x_list_tv_margin_end));
            ...
            marginLayoutParams2.setMarginEnd((int) getResources().getDimension(bip.e.x_list_tv_has_tag_margin_end));
