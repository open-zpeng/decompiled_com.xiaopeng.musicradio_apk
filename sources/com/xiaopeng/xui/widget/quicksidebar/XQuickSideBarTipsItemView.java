...
public class XQuickSideBarTipsItemView extends XView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        initDefaultColor();
        this.mTextSize = context.getResources().getDimension(bip.e.x_sidebar_tips_textsize);
        if (attributeSet != null) {
            ...
            this.mBackgroundColor = obtainStyledAttributes.getColor(bip.l.XQuickSideBarView_sidebarBackgroundColor, this.mBackgroundColor);
            obtainStyledAttributes.recycle();
        }
        final XFontScaleHelper create = XFontScaleHelper.create(getResources(), bip.e.x_sidebar_tips_textsize);
        ...
        this.mTextPaint.setTypeface(Typeface.create(getResources().getString(bip.j.x_font_typeface_number_bold), 0));
    ...
    private void initDefaultColor() {
        this.mTextColor = getColor(bip.d.x_side_bar_tips_text_color);
        this.mBackgroundColor = getColor(bip.d.x_side_bar_tips_bg_color);
    }
