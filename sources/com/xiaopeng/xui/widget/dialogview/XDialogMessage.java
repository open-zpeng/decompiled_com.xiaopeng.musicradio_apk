...
class XDialogMessage extends XFrameLayout {
    ...
    public XDialogMessage(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(bip.i.x_dialog_message, this);
        initView();
    }

    private void initView() {
        this.mTextMessage = (TextView) findViewById(bip.g.x_dialog_message);
        this.mImageView = (ImageView) findViewById(bip.g.x_dialog_icon);
    }
