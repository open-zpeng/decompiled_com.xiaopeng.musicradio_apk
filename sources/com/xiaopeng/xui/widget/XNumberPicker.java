...
public class XNumberPicker extends XLinearLayout {
    ...
    public XNumberPicker(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, bip.k.XNumberPicker);
    }

    public XNumberPicker(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, bip.k.XNumberPicker);
    }
    ...
    public XNumberPicker(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, bip.l.XNumberPicker, i, i2);
        this.mHideWheelUntilFocused = obtainStyledAttributes.getBoolean(bip.l.XNumberPicker_np_hideWheelUntilFocused, false);
        this.mTextLayout = obtainStyledAttributes.getInt(bip.l.XNumberPicker_np_textLayout, 1);
        this.mSolidColor = obtainStyledAttributes.getColor(bip.l.XNumberPicker_np_solidColor, 0);
        Drawable drawable = obtainStyledAttributes.getDrawable(bip.l.XNumberPicker_np_selectionDivider);
        if (drawable != null) {
        ...
        this.mSymbol = obtainStyledAttributes.getDrawable(bip.l.XNumberPicker_np_symbol);
        this.mSelectionDividerHeight = obtainStyledAttributes.getDimensionPixelSize(bip.l.XNumberPicker_np_selectionDividerHeight, (int) TypedValue.applyDimension(1, 2.0f, getResources().getDisplayMetrics()));
        this.mSelectionDividersDistance = obtainStyledAttributes.getDimensionPixelSize(bip.l.XNumberPicker_np_selectionDividersDistance, (int) TypedValue.applyDimension(1, 48.0f, getResources().getDisplayMetrics()));
        this.mTextLayoutMargin = obtainStyledAttributes.getDimensionPixelSize(bip.l.XNumberPicker_np_text_layout_margin, 0);
        this.mMinHeight = obtainStyledAttributes.getDimensionPixelSize(bip.l.XNumberPicker_np_internalMinHeight, -1);
        this.mMaxHeight = obtainStyledAttributes.getDimensionPixelSize(bip.l.XNumberPicker_np_internalMaxHeight, -1);
        int i5 = this.mMinHeight;
        if (i5 != -1 && (i4 = this.mMaxHeight) != -1 && i5 > i4) {
            throw new IllegalArgumentException("minHeight > maxHeight");
        }
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(bip.l.XNumberPicker_np_internalMinWidth, -1);
        this.mMaxWidth = obtainStyledAttributes.getDimensionPixelSize(bip.l.XNumberPicker_np_internalMaxWidth, -1);
        int i6 = this.mMinWidth;
        if (i6 != -1 && (i3 = this.mMaxWidth) != -1 && i6 > i3) {
            throw new IllegalArgumentException("minWidth > maxWidth");
        }
        this.mComputeMaxWidth = this.mMaxWidth == -1;
        this.mTextSize = obtainStyledAttributes.getDimensionPixelSize(bip.l.XNumberPicker_android_textSize, 20);
        this.mSelectedTextSize = obtainStyledAttributes.getDimensionPixelSize(bip.l.XNumberPicker_np_selectedTextSize, 20);
        this.mTextColors = obtainStyledAttributes.getColorStateList(bip.l.XNumberPicker_android_textColor);
        ...
        paint.setTypeface(Typeface.create(getResources().getString(bip.j.x_font_typeface_medium), 0));
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (acs.b(configuration)) {
            this.mTextColors = getContext().getResources().getColorStateList(bip.d.x_number_picker_text_color, null);
            postInvalidate();
        }
    }
