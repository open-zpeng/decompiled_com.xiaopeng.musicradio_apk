...
public class UTPageHitHelper {
    ...
    private String m71a(Object obj) {
        String simpleName;
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m71a = m71a(obj);
        if (this.A.containsKey(m71a)) {
            return this.A.get(m71a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m71a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m71a);
    ...
    private synchronized void m72b(Object obj) {
        String m71a = m71a(obj);
        if (this.A.containsKey(m71a)) {
            this.A.remove(m71a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m71a = m71a(obj);
            if (m71a != null && m71a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
                uw.a("lost 2001", "Last page requires leave(" + this.al + ").");
            }
            UTPageEventObject a2 = a(obj);
            if (!z && a2.isSkipPage()) {
                uw.a("skip page[pageAppear]", "page name:" + obj.getClass().getSimpleName());
                return;
            }
            ...
            uw.a("pageAppear", "The page object should not be null");
        }
    }
    ...
    public synchronized void updatePageProperties(Object obj, Map<String, String> map) {
        ...
        uw.a("updatePageProperties", "failed to update project, parameters should not be null and the map should not be empty");
    }
        ...
        if (obj != null) {
            ...
            if (a2.isPageAppearCalled()) {
                ...
                if (defaultTracker != null) {
                    ...
                    uw.a("Record page event error", "Fatal Error,must call setRequestAuthentication method first.");
                }
            } else {
                uw.a("UT", "Please call pageAppear first(" + b(obj) + ").");
            }
            this.z = new HashMap();
            if (a2.isSkipPage()) {
                a(a2);
            ...
            uw.a("pageDisAppear", "The page object should not be null");
        }
    }
