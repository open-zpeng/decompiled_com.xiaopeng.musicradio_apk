...
public class UTHitBuilders {
    ...
    public static class UTHitBuilder {
        ...
        public UTHitBuilder setProperty(String str, String str2) {
            if (!TextUtils.isEmpty(str) && str2 != null) {
                ...
                uw.a("setProperty", "key is null or key is empty or value is null,please check it!");
            }
            return this;
        }
        ...
        public Map<String, String> build() {
            ...
            if (a(hashMap)) {
                e(hashMap);
                d(hashMap);
                if (hashMap.containsKey(vn.EVENTID.toString())) {
                    return hashMap;
                }
                return null;
            }
        ...
        private static boolean a(Map<String, String> map) {
            if (map != null) {
                ...
                if (map.containsKey(vn.PAGE.toString())) {
                    uw.a("checkIlleagleProperty", "IlleaglePropertyKey(PAGE) is setted when you call the method setProperty or setProperties ,please use another key to replace it!");
                    return false;
                } else if (map.containsKey(vn.EVENTID.toString())) {
                    uw.a("checkIlleagleProperty", "IlleaglePropertyKey(EVENTID) is setted when you call the method setProperty or setProperties ,please use another key to replace it!");
                    return false;
                } else if (map.containsKey(vn.ARG1.toString())) {
                    uw.a("checkIlleagleProperty", "IlleaglePropertyKey(ARG1) is setted when you call the method setProperty or setProperties ,please use another key to replace it!");
                    return false;
                } else if (map.containsKey(vn.ARG2.toString())) {
                    uw.a("checkIlleagleProperty", "IlleaglePropertyKey(ARG2) is setted when you call the method setProperty or setProperties ,please use another key to replace it!");
                    return false;
                } else if (map.containsKey(vn.ARG3.toString())) {
                    uw.a("checkIlleagleProperty", "IlleaglePropertyKey(ARG3) is setted when you call the method setProperty or setProperties ,please use another key to replace it!");
                    return false;
                } else {
                    return true;
                }
        ...
        private static void d(Map<String, String> map) {
            if (map != null) {
                if (map.containsKey(FIELD_PAGE)) {
                    ...
                    map.put(vn.PAGE.toString(), map.get(FIELD_PAGE));
                }
                if (map.containsKey(FIELD_ARG1)) {
                    map.remove(FIELD_ARG1);
                    map.put(vn.ARG1.toString(), map.get(FIELD_ARG1));
                }
                if (map.containsKey(FIELD_ARG2)) {
                    map.remove(FIELD_ARG2);
                    map.put(vn.ARG2.toString(), map.get(FIELD_ARG2));
                }
                if (map.containsKey(FIELD_ARG3)) {
                    map.remove(FIELD_ARG3);
                    map.put(vn.ARG3.toString(), map.get(FIELD_ARG3));
                }
                if (map.containsKey(FIELD_ARGS)) {
                    map.remove(FIELD_ARGS);
                    map.put(vn.ARGS.toString(), map.get(FIELD_ARGS));
                }
                if (map.containsKey(FIELD_EVENT_ID)) {
                    map.remove(FIELD_EVENT_ID);
                    map.put(vn.EVENTID.toString(), map.get(FIELD_EVENT_ID));
                }
            }
        }
        ...
        private static void e(Map<String, String> map) {
            if (map != null) {
                if (map.containsKey(vn.PAGE.toString())) {
                    map.remove(vn.PAGE.toString());
                }
                if (map.containsKey(vn.EVENTID.toString())) {
                    map.remove(vn.EVENTID.toString());
                }
                if (map.containsKey(vn.ARG1.toString())) {
                    map.remove(vn.ARG1.toString());
                }
                if (map.containsKey(vn.ARG2.toString())) {
                    map.remove(vn.ARG2.toString());
                }
                if (map.containsKey(vn.ARG3.toString())) {
                    map.remove(vn.ARG3.toString());
                }
    ...
    public static class UTCustomHitBuilder extends UTHitBuilder {
        ...
        public Map<String, String> build() {
            ...
            if (build != null) {
                String str = build.get(vn.PAGE.toString());
                String str2 = build.get(vn.ARG1.toString());
                if (str2 != null) {
                    build.remove(vn.ARG1.toString());
                    build.remove(vn.PAGE.toString());
                    Map<String, String> a = ve.a(build);
                    a.put(vn.ARG1.toString(), str2);
                    a.put(vn.PAGE.toString(), str);
                    return a;
                }
            }
            return build;
