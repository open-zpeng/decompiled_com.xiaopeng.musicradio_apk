...
public class UTSecuritySDKRequestAuthentication implements IUTRequestAuthentication {
    ...
    */
    ...
    public String getSign(String str) {
        ...
        if (this.g == null) {
            uw.a("UTSecuritySDKRequestAuthentication:getSign", "There is no appkey,please check it!");
            return null;
        } else if (str == null) {
            return null;
        } else {
            if (this.b != null && (cls = this.a) != null && this.f132a != null && this.f134b != null && this.f135c != null && this.f133a != null && this.c != null) {
                try {
